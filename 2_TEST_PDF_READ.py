...
def save_text_to_csv(text_data, csv_path):
    try:
        combined_text = ' '.join(text_data)  # Concatenate all text data into one string
...
# Example usage
pdf_dir = r'./test_today'  # Directory to watch for new PDF files
csv_dir = r'./extracted_test_csv'  # Directory to save the CSV files
